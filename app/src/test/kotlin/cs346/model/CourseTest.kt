...
class CourseTest {
    ...
    @Test
    fun testAddCourses() {
        courseList.add("CS 001", "Wed, Fri | 2:30 PM - 4:20 PM | MC 2035", "Jeff Avery", "Fantastic course", "Nice prof", 4)
        courseList.add("CS 002", "Tue, Thu | 2:30 PM - 4:20 PM | MC 1012", "Feridun", "Amazing yay", "hooray i love this prof", 5)
